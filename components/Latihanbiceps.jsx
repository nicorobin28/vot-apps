  ...
  const items = [
    {
      type: 'main',
      text: 'Biceps Curl',
      image: require('../assets/bicepsCurl.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Biceps Barbel Curl',
      image: require('../assets/bicepsbarblecurl.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Hummer Curl',
      image: require('../assets/hummerCurl.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Incline Dumbell Curl',
      image: require('../assets/InclineDumbellCurl.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Biceps Curl Machine',
      image: require('../assets/barbelmachine.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Dumbell Preacher Curl',
      image: require('../assets/dumbellpeachercurl.mp4'),
      format: 'video',
    },
  ];
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>LATIHAN UNTUK BICEPS</Text>
