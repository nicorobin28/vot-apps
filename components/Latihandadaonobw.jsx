...
const Latihanforearm = ({navigation}) => {
  ...
  const items = [
    {
      type: 'main',
      text: 'Regular Push Up',
      image: require('../assets/regularPushUp.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Wide Push Up',
      image: require('../assets/widePushUp.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Incline Push Up',
      image: require('../assets/inclinePushUp.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Decline Push Up',
      image: require('../assets/declinePushUp.mp4'),
      format: 'video',
    },
  ];
