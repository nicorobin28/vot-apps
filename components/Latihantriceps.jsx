...
const Latihanforearm = ({navigation}) => {
  ...
  const items = [
    {
      type: 'main',
      text: 'Triceps Extension',
      image: require('../assets/tricepsExtension.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Cable Rop Extension',
      image: require('../assets/cableropextension.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Triceps Kickback',
      image: require('../assets/tricepsKickBack.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Overhand Triceps Extension',
      image: require('../assets/OverhandTricepsExtension.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Triceps Push Down',
      image: require('../assets/UnderhandTricepsPushdown.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Overhead Triceps Extension',
      image: require('../assets/OverheadTricepsExtension.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Triceps Dips',
      image: require('../assets/tricepsdips.mp4'),
      format: 'video',
    },
  ];
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>LATIHAN UNTUK TRICEPS</Text>
