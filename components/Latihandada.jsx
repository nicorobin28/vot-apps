  ...
  const items = [
    {
      type: 'main',
      text: 'Bench Press',
      image: require('../assets/benchPress.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Dumbbell Bench Press',
      image: require('../assets/dumbellbenchpress.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Incline Bench Press',
      image: require('../assets/inclineBenchPress.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Decline Bench Press',
      image: require('../assets/declinebenchpress.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Chest Fly',
      image: require('../assets/chestFly.mp4'),
      format: 'video',
    },
  ];
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>LATIHAN UNTUK PECTORALIS(DADA)</Text>
