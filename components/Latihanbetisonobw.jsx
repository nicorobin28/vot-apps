...
const Latihanbetisonobw = ({navigation}) => {
  const teknikData = [
  ...
  const items = [
    {
      type: 'main',
      text: 'Calf Raise',
      image: require('../assets/calfraise.mp4'),
      format: 'video',
    },
    {
      type: 'text',
      image: require('../assets/calfraise2.mp4'),
      format: 'video',
    },
  ];
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>
              LATIHAN UNTUK OTOT GAASTROCNEMIUS (BETIS)
            </Text>
...
export default Latihanbetisonobw;
