  ...
  const items = [
    {
      type: 'main',
      text: 'Cabble Crunch',
      image: require('../assets/cabbleCrunch.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Abdominal Isolator Machine',
      image: require('../assets/AbdominalIsolatorMachine.mp4'),
      format: 'video',
    },
  ];
