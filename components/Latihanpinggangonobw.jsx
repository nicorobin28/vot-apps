...
const Latihanforearm = ({navigation}) => {
  ...
  const items = [
    {
      type: 'main',
      text: 'Superman Back Up',
      image: require('../assets/supermanBackUp.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Close Up Back Up',
      image: require('../assets/closeupbackup.mp4'),
      format: 'video',
    },
    {
      type: 'main',
    ...
    },
    {
      type: 'main',
      text: 'High Plank',
      image: require('../assets/highplank.jpg'),
      format: 'image',
    },
    {
      type: 'main',
    ...
    {
      type: 'main',
      text: 'Plank With Arm Reach',
      image: require('../assets/plankwithreacharm.jpg'),
      format: 'image',
    },
    {
      type: 'main',
    ...
    },
    {
      type: 'main',
      text: 'Reverse Plank',
      image: require('../assets/reverseplank.jpg'),
      format: 'image',
    },
    {
      type: 'main',
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>
              LATIHAN UNTUK ERECTUS SPINAE (PINGGANG)
            </Text>
