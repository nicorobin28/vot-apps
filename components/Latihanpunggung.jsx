  ...
  const items = [
    {
      type: 'main',
      text: 'Lat Pull Down',
      image: require('../assets/latPullDown.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Barbell Row',
      image: require('../assets/barbellRow.mp4'),
      format: 'video',
    },
    {
      type: 'text',
      image: require('../assets/barbelRow2.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Bent Over Row',
      image: require('../assets/bentOverRow.mp4'),
      format: 'video',
    },
    {
      type: 'text',
      image: require('../assets/bentOverRow2.mp4'),
      format: 'video',
    },

    {
      type: 'main',
      text: 'Dumbbell Row',
      image: require('../assets/dumbellrow.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Seated Cabble Row',
      image: require('../assets/seatedcabblerow.mp4'),
      format: 'video',
    },
    {
      type: 'main',
      text: 'Rope Pullover',
      image: require('../assets/RopePullover.mp4'),
      format: 'video',
    },
  ];
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            <Text style={styles.subTitle}>
              LATIHAN UNTUK LATICIMUS DORCI (PUNGGUNG)
            </Text>
